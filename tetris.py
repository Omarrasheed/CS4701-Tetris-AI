...
# Source code inspired by https://github.com/nuno-faria/tetris-ai
...
class Tetris:
    ...
    def get_finished_40_lines(self):
        return self.lines_cleared >= 40
    ...
    def play(self, x, rotation, render=False, render_delay=None):
        ...
        # Uncomment the following lines to include the heuristic function in scoring

        # a = -0.4
        # b = 0.8
        # c = -0.4
        # d = -0.1
        # state = self._get_board_props(self.board)
        # lines = state[0]
        # holes = state[1]
        # total_bumpiness = state[2]
        # sum_height = state[3]
        # score = b*4 - (a * sum_height + b * lines + c * holes + d * total_bumpiness)
        # self.score -= score
